...
class Game:
    ...
    def show_game_over(self):
        self.surface.fill(BACKGROUND_COLOR)
        font = pygame.font.SysFont("arial", 30)
        line_1 = font.render(f"Game Over! Your score is {self.snake.length}", True, (200, 200, 200))
        self.surface.blit(line_1, (200, 300))
        line_2 = font.render("To play again press Enter. To exit press Escape!", True, (200, 200, 200))
